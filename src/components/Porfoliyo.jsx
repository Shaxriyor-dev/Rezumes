  ...
  return (
    <div className="w-[910px] h-[100%] p-6 inset-ring-1 inset-ring-neutral-900 mt-10 rounded-lg bg-[#121212]">
      ...
      {data.map((item) => {
        ...
        >
          <div
            className="mt-10 p-8 rounded-lg bg-neutral-950 inset-shadow-sm inset-shadow-indigo-500  flex justify-center items-center gap-10"
          >
            <div>
              <img
                className=" object-fill rounded-md  h-[180px] w-[320px] shadow-lg shadow-blue-500/50 "
                src={item.img}
                alt=""
              />
            </div>
            <div>
              ...
              <p className="w-[500px] text-[14px] font-[Poppins] p-1.5">{item.title}</p>
